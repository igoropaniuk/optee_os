...
#define PSCI_CPU_ON			PSCI_FN(0x03)
#define PSCI_CPU_ON_SMC64		(PSCI_CPU_ON | 0x40000000)
#define PSCI_AFFINITY_INFO		PSCI_FN(0x04)
#define PSCI_MIGRATE			PSCI_FN(0x05)
#define PSCI_MIGRATE_INFO_TYPE		PSCI_FN(0x06)
#define PSCI_MIGRATE_INFO_UP_CPU	PSCI_FN(0x07)
#define PSCI_SYSTEM_OFF			PSCI_FN(0x08)
#define PSCI_SYSTEM_RESET		PSCI_FN(0x09)
#define PSCI_PSCI_FEATURES		PSCI_FN(0x0a)
#define PSCI_CPU_FREEZE			PSCI_FN(0x0b)
#define PSCI_CPU_DEFAULT_SUSPEND	PSCI_FN(0x0c)
#define PSCI_NODE_HW_STATE		PSCI_FN(0x0d)
#define PSCI_SYSTEM_SUSPEND		PSCI_FN(0x0e)
